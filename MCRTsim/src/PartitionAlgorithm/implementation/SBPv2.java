 ...
 * @author ShiuJia
 */
public class SBPv2 extends PartitionAlgorithm
{
    ...
    public SBPv2()
    {
        this.setName("Similarity-Based Partitioning version2");
    }
...
//            for(int x = 0; x < this.similarityForAllTask.size(); x++)
//            {
//                for(Task t : this.similarityForAllTask.get(x).similarityTask)
//                {
//                    if(allTs.contains(t))
//                    {
//                        i = this.findMinUCore(cores).getID() - 1;
